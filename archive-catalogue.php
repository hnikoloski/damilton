...
<div class="px-side-padding-mobile lg:px-side-padding-desktop">
    <h2 class="text-[4.8rem] text-beige my-[4rem] relative inline-block pr-[1.2em] leading-none font-medium"><?php pll_e('Catalogues'); ?>
        <span class="leading-none catalogue-total-num text-white absolute -top-[1.2rem] right-0 bg-none text-[2rem] px-[1.2rem] py-[0.6rem] rounded-[100px] border border-solid border-beige"><?php echo wp_count_posts('catalogue')->publish; ?></span>
    </h2>
    ...
    <div class="flex flex-wrap items-stretch justify-between catalogues-results align-stretch">
        ...
        <?php foreach ($catalogues as $catalogue) : ?>
            <div class="pb-[4.8rem] border-b border-solid border-[#909090] w-full">
                ...
                ?>
                    <div class="swiper catalogue-slider" data-unique-id="<?= $unique_id; ?>">
                        ...
                        <div class="swiper-wrapper relative">
                            <div class="w-[8rem] h-[8rem] bg-beige drag-me flex justify-center items-center absolute hidden pointer-events-none z-10 rounded-full shadow-loadShadow">
